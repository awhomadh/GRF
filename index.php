                    ...
                    <ul class="navbar-nav mb-lg-7">
                        ...
                        <li class="nav-item">
                            <a href="./docs/index.html" class="nav-link">
                                ...
                                <span class="badge text-bg-primary rounded-pill ms-auto">v1.6</span>
                            </a>
                        </li>
                        <li class="nav-item">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col d-flex justify-content-between">
                                                ...
                                                <span class="text-primary">
                                                    <svg viewBox="0 0 24 24" height="32" width="32" xmlns="http://www.w3.org/2000/svg"><path d="M18.75,14.25H16.717a1.342,1.342,0,0,0-.5,2.587l2.064.826a1.342,1.342,0,0,1-.5,2.587H15.75" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/><path d="M17.25 14.25L17.25 13.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/><path d="M17.25 21L17.25 20.25" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/><path d="M11.250 17.250 A6.000 6.000 0 1 0 23.250 17.250 A6.000 6.000 0 1 0 11.250 17.250 Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/><path d="M3.75 14.25L8.25 14.25" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/><path d="M8.25 14.25L8.25 6.75" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/><path d="M11.25 9.75L11.25 8.25" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/><path d="M5.25 14.25L5.25 9.75" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/><path d="M7.5,20.25H2.25a1.43,1.43,0,0,1-1.5-1.415V2.335A1.575,1.575,0,0,1,2.25.75H12.879a1.5,1.5,0,0,1,1.06.439l2.872,2.872a1.5,1.5,0,0,1,.439,1.06V7.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/></svg>
                                                </span>
                                            </div>
                                        </div> <!-- / .row -->
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row justify-content-between">
                                            <div class="col">
                                                ...
                                                <!-- Title -->
                                                <h5 class="text-uppercase text-body-secondary fw-semibold mb-2 d-flex align-items-center">
                                                    Pageviews
                                                ...
                                                <p class="fs-6 text-body-secondary mb-0">
                                                    ...
                                                    <span class="badge text-bg-danger-soft fs-6 fw-bold mb-n1">
                                                        <svg viewBox="0 0 24 24" height="10" width="10" xmlns="http://www.w3.org/2000/svg"><path d="M23.25 11.25L23.25 18 16.5 18" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/><path d="M23.25,18l-7.939-7.939a1.5,1.5,0,0,0-2.122,0l-3.128,3.128a1.5,1.5,0,0,1-2.122,0L.75,6" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/></svg>
                                                        9.2%
                                                    </span>
                                                    from 134,969
                                                </p>
                                ...
                                <table id="projectsTable" class="table align-middle table-edge table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-body-secondary">Jon Richardson</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-body-secondary">Alba Monday</td>
                                            <td class="text-end"><span class="badge text-bg-success rounded-pill">Completed</span></td>
                                        </tr>
                                        <tr>
                                            <td>3</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-body-secondary">Levente Kosa</td>
                                            <td class="text-end"><span class="badge text-bg-warning rounded-pill">In-progress</span></td>
                                        </tr>
                                        <tr>
                                            <td>5</td>
                                            ...
                                            <td class="text-body-secondary">Andy Webb</td>
                    ...
                    <div class="col-xxl-7 d-flex">
                        ...
                        <div class="card border-0 flex-fill w-100">
                            <div class="card-header border-0 card-header-space-between">
                                ...
                                <!-- Label -->
                                <h5 class="text-uppercase text-body-secondary fw-semibold mb-0">
                                    <span class="legend-circle-lg bg-primary"></span>
                                    Projections
                                </h5>

                                <!-- Label -->
                                <h5 class="text-uppercase text-body-secondary fw-semibold mb-0 ms-4">
                                ...
                                <table class="table align-middle table-edge table-hover table-nowrap mb-0">
                                    ...
                                    <tbody class="list">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar avatar-circle avatar-xs me-2">
                                                    <img src="./assets/images/profiles/profile-14.jpeg" alt="..." class="avatar-img" width="30" height="30">
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar avatar-circle avatar-xs me-2">
                                                    <img src="./assets/images/profiles/profile-23.jpeg" alt="..." class="avatar-img" width="30" height="30">
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar avatar-circle avatar-xs me-2">
                                                    <img src="./assets/images/profiles/profile-16.jpeg" alt="..." class="avatar-img" width="30" height="30">
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar avatar-circle avatar-xs me-2">
                                                    <img src="./assets/images/profiles/profile-17.jpeg" alt="..." class="avatar-img" width="30" height="30">
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar avatar-circle avatar-xs me-2">
                                                    <img src="./assets/images/profiles/profile-19.jpeg" alt="..." class="avatar-img" width="30" height="30">
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar avatar-circle avatar-xs me-2">
                                                    <img src="./assets/images/profiles/profile-25.jpeg" alt="..." class="avatar-img" width="30" height="30">
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar avatar-circle avatar-xs me-2">
                                                    <img src="./assets/images/profiles/profile-27.jpeg" alt="..." class="avatar-img" width="30" height="30">
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar avatar-circle avatar-xs me-2">
                                                    <img src="./assets/images/profiles/profile-30.jpeg" alt="..." class="avatar-img" width="30" height="30">
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar avatar-circle avatar-xs me-2">
                                                    <img src="./assets/images/profiles/profile-29.jpeg" alt="..." class="avatar-img" width="30" height="30">
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar avatar-circle avatar-xs me-2">
                                                    <img src="./assets/images/profiles/profile-22.jpeg" alt="..." class="avatar-img" width="30" height="30">
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar avatar-circle avatar-xs me-2">
                                                    <img src="./assets/images/profiles/profile-10.jpeg" alt="..." class="avatar-img" width="30" height="30">
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar avatar-circle avatar-xs me-2">
                                                    <img src="./assets/images/profiles/profile-18.jpeg" alt="..." class="avatar-img" width="30" height="30">
                                                </div>
